...
#include "Drag.cpp"
#include "weight_contribution.cpp"
...
int main() {
    ...
    double passengers_kg, cargo_kg, tank_fraction, ambient_temp, throttle, totalTime;
    ...
    std::cout << "Enter simulation time in seconds: ";
    std::cin >> totalTime;
    if (totalTime <= 0) {
        totalTime = 100.0; // Default to 100s if input is invalid
    }
