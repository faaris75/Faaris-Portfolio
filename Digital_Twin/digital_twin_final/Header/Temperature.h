...
class Temperature {
    private:
        ...
        const double THERMOSTAT_OPEN_TEMP = 88.0; 
        const double THERMAL_MASS_INVERSE = 0.0012; 
        const double RADIATOR_EFFICIENCY = 0.15;  // show derivations for constants
    ...
    public:
        ...
        void update(int rpm, double load, double speed, double dt);
